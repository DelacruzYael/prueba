...
<?php }
				...
				<li><a href="https://calendly.com/israguilas01/ljl"><i></i>Cita Virtual</a></li>
					<li class="dropdown">
                                 <a class="dropdown-toggle" data-toggle="dropdown" href="#change-colors" aria-expanded="false">Colores</a>
                                <ul class="dropdown-menu" role="menu">
									<li role="presentation"><a role="menuitem" class="changecolor red-text" tabindex="-1" href="#" title="Red color">Rosa</a></li>
